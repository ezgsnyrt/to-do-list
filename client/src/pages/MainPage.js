...
const MainPage = () => {
  const tasks = [
    ...
    },
    {
      ...
      description: "Write the backend code for a simple to-do list application and turn it into a post.",
      status: "pending",
      priority: "high",
    ...
    },
    {
      ...
      description: "Perform the final checks on my backend course project and write its documentation.",
      status: "pending",
      priority: "high",
